// // server.js - FIXED CLERK SYNC VERSION
...
// // Sync Clerk users with MongoDB - FIXED VERSION
...
//       // Clerk API returns data in a specific format
//       // The actual user data is in response.data.data array
//       if (response.data && Array.isArray(response.data.data)) {
//         clerkUsers = response.data.data;
//         console.log(`📋 Fetched ${clerkUsers.length} users from Clerk API`);
//       } else if (Array.isArray(response.data)) {
//         // Some Clerk API versions return array directly
...
//         // Clerk v1 API has email_addresses array
...
// // Get all users (admin endpoint) - FIXED VERSION
...
//       },
//       test_sync: {
//         url: "http://localhost:5000/api/admin/users/sync-clerk",
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json"
//         }
...
// // [Keep your existing smart image fallback middleware...]

// // ==================== PAYMENT ROUTES ====================
// // [Keep your existing payment routes...]

// // ==================== STATIC FILE SERVING ====================
// // [Keep your existing static file serving...]
...
//         console.log("   📍 Sync Endpoint: POST /api/admin/users/sync-clerk");
//         console.log("   📍 Test Connection: GET /api/clerk-status");
//       } else {
...
//       console.log("\n💡 Quick Test:");
//       console.log("   1. Check Clerk config: curl http://localhost:5000/api/clerk-status");
//       console.log("   2. Test sync: curl -X POST http://localhost:5000/api/admin/users/sync-clerk");
//       console.log("   3. List users: curl http://localhost:5000/api/admin/users");
