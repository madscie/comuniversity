// src/pages/public/PaymentCancelledPage.jsx
import React from 'react';
import { Link, useLocation } from 'react-router-dom';
import { FaTimesCircle, FaArrowLeft, FaShoppingCart, FaExclamationTriangle, FaHome } from 'react-icons/fa';
        ...
        <div className="p-8">
          ...
          <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl p-6 mb-8">
            <div className="flex items-start mb-3">
              <FaExclamationTriangle className="w-5 h-5 text-orange-600 dark:text-orange-400 mr-2 mt-0.5 flex-shrink-0" />
            ...
            <ul className="space-y-2 text-orange-700 dark:text-orange-400 text-sm">
              <li className="flex items-start">
                <span className="inline-block w-2 h-2 bg-orange-500 rounded-full mt-1.5 mr-3 flex-shrink-0"></span>
          ...
          <div className="space-y-4">
            {articleId ? (
              <>
                <button
                  onClick={() => window.location.href = `/articles/${articleId}`}
            ...
            <Link
              to="/"
              className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white py-4 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center shadow-lg"
            >
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <div className="text-center">
              ...
              <p className="text-sm font-medium text-blue-600 dark:text-blue-400">
                support@jordansgeneraldealers.com
              </p>
            </div>
          </div>
        </div>
